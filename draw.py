...
# 数据集
dataset = 'forth87-108(10-26)'
# dataset = '108-137(11-15)'
# 输出文件夹
output = './output/'
...
# 读取文件路径
read_path = 'F:\spectrum_data\/' + dataset + '/'
# 保存文件路径
save_path = 'F:\spectrum_data\TrainSp256\TrainSp256/'
#图像参数文件保存路径
# param_save_path = r'F:\spectrum_data\图片参数标签/'
